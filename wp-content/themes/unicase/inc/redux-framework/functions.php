...
function redux_apply_footer_contact_info( $contact_info ) {
	...
	if( !empty( $unicase_options['footer_contact_info'] ) ) {
...
function redux_apply_copyright_text( $copyright_text ) {
	...
	if( !empty( $unicase_options['footer_credit'] ) ) {
...
function redux_apply_post_item_animation( $post_classes ) {
	...
	if( isset( $unicase_options['post_item_animation'] ) && $unicase_options['post_item_animation'] != 'none' ) {
		$post_classes[] = 'wow';
