...
add_action( 'woocommerce_before_shop_loop_item',	'unicase_product_image_action_wrapper',			1 );
add_action( 'woocommerce_before_shop_loop_item',	'woocommerce_show_product_loop_sale_flash',		10 );
add_action( 'woocommerce_before_shop_loop_item',	'unicase_product_labels',						11 );
add_action( 'woocommerce_before_shop_loop_item',	'unicase_quick_view_link',						15 );
add_action( 'woocommerce_before_shop_loop_item',	'unicase_template_loop_product_thumbnail',		20 );
add_action( 'woocommerce_before_shop_loop_item',	'unicase_product_image_action_wrapper_close',	30 );
...
// List View
add_action( 'woocommerce_list_after_shop_loop_item',	'woocommerce_template_loop_rating',			5 );
add_action( 'woocommerce_list_after_shop_loop_item',	'woocommerce_template_loop_price',			6 );
