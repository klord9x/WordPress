    ...
    $( document ).ready( function() {
        ...
        if( unicase.enable_live_search == '1' ) {
            var searchProducts = new Bloodhound({
                ...
                prefetch: unicase.ajax_url + '?action=products_live_search&fn=get_ajax_search',
                remote: {
                    url: unicase.ajax_url + '?action=products_live_search&fn=get_ajax_search&terms=%QUERY',
                    wildcard: '%QUERY',
                },
