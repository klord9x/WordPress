...
<div class="products-carousel">
    ...
    if ( $products->have_posts() ) :
        ?>
        <div id="unicase_products_carousel_<?php echo esc_attr( $product_content ); ?>" class="owl-carousel unicase-owl-carousel owl-outer-nav has-grid products">
            <?php
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                $("#unicase_products_carousel_<?php echo esc_attr( $product_content ); ?>").owlCarousel({
