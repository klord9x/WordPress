...
<div class="home-tabs" role="tabpanel">
    ...
    <div class="nav-tabs-wrapper">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" <?php if( $key == 0 ){ echo 'class="active"'; } ?>><a href="#<?php echo esc_attr( $tab['shortcode'] );?>" aria-controls="<?php echo esc_attr( $tab['shortcode'] );?>" role="tab" data-toggle="tab"><?php echo apply_filters( 'unicase_homepage_tab_title_'. $key , $tab['title'] ); ?></a></li>
                <?php endif; ?>
        	<?php endforeach; ?>
        </ul><!-- /.nav-tabs -->
