		...
		<div class="products-masonry-wrap">
			...
			<ul class="products masonry-products row <?php echo esc_attr($loop_class)?>">
				...
				if($products->have_posts()):
						while ( $products->have_posts() ) : $products->the_post(); global $post,$product;
							...
							?>
							<li id="pro-<?php echo $post->ID?>" class="<?php echo esc_attr($product_style); ?> <?php echo esc_attr($post_col)?> <?php echo implode(' ', $cat_class)?>">
