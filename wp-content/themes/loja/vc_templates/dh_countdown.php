...
<div class="countdown-item">
	<div class="countdown-item-label">'.esc_html__('Days','loja').'</div>
	<div class="countdown-item-value">%D</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.esc_html__('Hours','loja').'</div>
	<div class="countdown-item-value">%H</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.esc_html__('Minuts','loja').'</div>
	<div class="countdown-item-value">%M</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.esc_html__('Seconds','loja').'</div>
