...
if(isset($use_heading_style) && $use_heading_style){
	$css_class .= ' heading-nice-border ';
	$text = '<span class="nice-border"><span class="nice-border-bottom-right"></span><span class="nice-border-top-left"></span><span class="nice-border-content">'.$text.'</span></span>';
}
$output = '';
