...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'loja' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'loja' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
	...
	<div id="payment">
		...
		<h3><?php esc_html_e( 'Payment', 'loja' ); ?></h3>
		<ul class="payment_methods methods">
			<?php
				if ( $available_gateways = WC()->payment_gateways->get_available_payment_gateways() ) {
					...
					echo '<p>' . esc_html__( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'loja' ) . '</p>';
		...
		<div class="form-row">
			...
			<?php
				$pay_order_button_text = apply_filters( 'woocommerce_pay_order_button_text', esc_html__( 'Pay for order', 'loja' ) );
