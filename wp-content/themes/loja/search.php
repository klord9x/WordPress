...
$loadmore_text = dh_get_theme_option('blogs-loadmore-text',esc_html__('Load More','loja'));
										...
										<div class="hentry-wrap">
											...
											<div class="entry-info<?php if(!empty($hide_thumbnail)):?> entry-hide-thumbnail<?php endif;?>">
												<div class="entry-header">
													...
													<div class="entry-format nice-border">
														...
														<span class="nice-border-content">
															...
															<?php elseif (has_post_thumbnail() || $post_format == 'gallery'):?>
													...
													<div class="entry-meta icon-meta">
														<?php 
														dh_post_meta($show_date,$show_comment,$show_category,$show_author,true,' ',null,true); 
														?>
													</div>
												</div>
												...
												<div class="readmore-link">
													<a href="<?php the_permalink()?>"><?php esc_html_e("Read More", 'loja');?></a>
												</div>
												<?php endif;?>
											</div>
										</div>
