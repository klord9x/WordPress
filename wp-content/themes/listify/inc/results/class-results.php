...
class Listify_Results {
	...
	public static function register_scripts() {
		...
		$settings = array(
			...
			'mapService'        => apply_filters( 'listify_map_service_settings', array(
				'service'     => get_theme_mod( 'map-service-provider', 'googlemaps' ),
				'center'      => array_map( 'trim', explode( ',', listify_sanitize_coordinate( get_theme_mod( 'map-behavior-center', '' ) ) ) ),
