...
if ( 'vc_tour' == $this->shortcode ) {
	$output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . esc_attr__( 'Previous tab', 'compactor' ) . '">' . esc_html__( 'Previous tab', 'compactor' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' .esc_attr__( 'Next tab', 'compactor' ) . '">' .esc_html__( 'Next tab', 'compactor' ) . '</a></span></div>';
}
