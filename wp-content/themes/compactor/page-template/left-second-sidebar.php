<?php
/*
Template Name: left second sidebar
*/
get_header();
if ( ! ( is_front_page() ) ) {
...
<?php } ?>
  ...
  <main class="l-main row">
      ...
      <?php if (is_active_sidebar ('sidebar-left')) : ?>
          <aside class="large-4 small-12 columns sidebar second-sidebar-left">
              <?php dynamic_sidebar ('sidebar-left'); ?>
          </aside><!-- #secondary -->
      <?php endif; ?>
    <div class="main large-<?php if ( is_active_sidebar( 'sidebar-left' ) ) { echo "8"; } else { echo "12"; } ?> small-12 columns">
